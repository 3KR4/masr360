const ar = {
  ...
  sectionsTitles: {
    ...
    what_is_m360: {
      tag: "ما هو مصر 360؟",
      titleLine1: "دولة واحدة.",
      titleLine2: "من كل الزوايا.",
      desc: "مصر 360° هي منصة سياحية تفاعلية وألعابية وبوابتك الشاملة لمصر — تجمع 27 محافظة، وأماكنها، وتاريخها، وثقافتها، ولياليها، وقصصها المخفية في تجربة غامرة واحدة.",
      formulaMasr: "مصر",
      formulaMasrVal: "الوطن والحضارة",
      formula360: "360°",
      formula360Val: "كل زاوية. كل محافظة. كل لحظة.",
      formulaM360: "مصر 360",
      formulaM360Val: "التجربة المصرية الكاملة.",
      stat1Num: "27",
      stat1Label: "محافظة",
      stat2Num: "+1,000",
      stat2Label: "مكان للاكتشاف",
      stat3Num: "1",
      stat3Label: "منصة متكاملة",
      stat4Num: "∞",
      stat4Label: "قصة للاستكشاف",
      positioningText: "مصر 360 ليست مجرد دليل سياحي تقليدي؛ بل تحول استكشاف مصر إلى رحلة تفاعلية تربط بين الاستكشاف، التحديات، المكافآت، والتقدم المستمر.",
      quote: "مصر ليست مجرد وجهة. إنها تجربة.",
    },

    how_it_works: {
      tag: "كيف يعمل مصر 360",
      titleLine1: "اكتشف. العب.",
      titleLine2: "اكسب. استكشف.",
      desc: "رحلتك في مصر تصبح أكثر من مجرد مشاهدة معالم. استكشف الوجهات، واكتشف التفاصيل المخفية، وأكمل التحديات، واجمع المكافآت أثناء تنقلك في عالم مصر 360.",
      btn: "ابدأ رحلتك",

      step1Num: "01",
      step1Title: "اكتشف مصر",
      step1Sub: "استكشف محافظات مصر الـ27 واكتشف أماكن جديدة.",

      step2Num: "02",
      step2Title: "العب التحديات",
      step2Sub: "اختبر معرفتك من خلال تحديات تفاعلية ممتعة.",

      step3Num: "03",
      step3Title: "اكسب العملات",
      step3Sub: "اكسب أرصدة مع الاستكشاف وإكمال التحديات.",

      step4Num: "04",
      step4Title: "تسلق قائمة المتصدرين",
      step4Sub: "نافس المستكشفين الآخرين واصعد في قائمة المتصدرين.",

      step5Num: "05",
      step5Title: "افتح المكافآت",
      step5Sub: "استخدم أرصدتك لفتح مكافآت وخصومات حصرية.",

      step6Num: "06",
      step6Title: "عِش تجربة M360",
      step6Sub: "اكتشف تجربة M360 الكاملة مع تطور رحلتك.",

      ecoTitle: "منظومة المكافآت ومجتمع المستكشفين في M360",
      eco1Title: "عملات ذات قيمة حقيقية",
      eco1Desc: "كل تحدٍ تكمله ووجهة تكتشفها تمنحك عملات M360 ذات قيمة حقيقية داخل المنصة.",
      eco2Title: "خصومات المتجر والحرف اليدوية",
      eco2Desc: "استبدل عملاتك بخصومات حصرية على المنتجات المصرية اليدوية الأصيلة والحرف التراثية.",
      eco3Title: "لوحة متصدري المستكشفين",
      eco3Desc: "تنافس مع زملائك المسافرين، وتتبع تقدمك، وارتقِ في تصنيف المستكشفين الرسمي.",
      eco4Title: "منتجات M360 ومكافآت الانطلاق",
      eco4Desc: "افتح منتجات M360 الرسمية، وتصاريح الوصول المبكر، ومكافآت الإطلاق الحصرية.",

      quote: "كلما استكشفت أكثر، كلما فتحت المزيد.",
    },
    support_cta: {
      title: "هل تحتاج مساعدة في",
      title_gold: "رحلتك؟",
      subtitle:
    ...
    masr_events_page: {
      mainTitle: "الأحداث القادمة",
      subTitle:
        "اكتشف أحدث الأحداث التي تدور في مصر. من المهرجانات الثقافية إلى العروض الحية، ابحث عن شيء مثير لتشاركه.",
    },
    ...
    explore_games: {
      ...
      btn: "رؤية كل الألعاب",
      exploreMoreTag: "المزيد من المغامرات بانتظارك",
      exploreMoreTitleLine1: "هل أنت مستعد لـ",
      exploreMoreTitleLine2: "مغامرتك القادمة؟",
      exploreMoreSub:
        "اكتشف المزيد من التجارب التي لا تُنسى في جميع أنحاء مصر. من العجائب القديمة إلى الملاذات الحديثة — هناك الكثير لاستكشافه.",
      exploreMoreBtn: "استكشف الكل",
      feature1: "أماكن أكثر",
      feature2: "تجارب جديدة",
      feature3: "الكل في مكان واحد",
    },
  },
  sideNav: {
  ...
  analytics: {
    questionsSubmits: "إجابات الأسئلة",
    totalVisits: "إجمالي زيارات الصفحات",
    totalWaitlist: "قائمة الانتظار",
    totalGamePlayers: "لاعبو اللعبة",
    totalFormSubmitters: "مقدمو النماذج",
    totalLeaderboard: "لوحة المتصدرين",
    recentVisits: "أحدث الزيارات",
    recentWaitlist: "أحدث عمليات التسجيل",
    gamePlayers: "لاعبو اللعبة",
    ip: "IP",
    userAgent: "المتصفح",
    visits: "الزيارات",
    lastSeen: "آخر ظهور",
